...
CWaveSinesInstrument::CWaveSinesInstrument(void)
{
    //m_time = 0;
}
...
void CWaveSinesInstrument::Start()
{
...
void CWaveSinesInstrument::SetNote(CNote* note)
{
...
bool CWaveSinesInstrument::Generate()
{
    m_sines.Generate();
